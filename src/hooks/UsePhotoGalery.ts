...
export function usePhotoGallery() {
    ...
    useEffect(() => {
        const loadSaved = async () => {
            ...
            const photosPerSession = (photosString ? JSON.parse(photosString) : {}) as { [id: string]: Photo[] };
...
const savePicture = async (photo: CameraPhoto, fileName: string, writeFile: Function): Promise<Photo> => {
